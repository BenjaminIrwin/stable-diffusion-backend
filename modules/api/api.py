...
class Api:
    ...
    def img2imgapi(self, img2imgreq: StableDiffusionImg2ImgProcessingAPI):
        ...
        script_args = [0, '<ul>\n<li><code>CFG Scale</code> should be 2 or lower.</li>\n</ul>\n', True, True, '', '', True, 50, True, 1.0, 0.0, False, 4, 0.5, 'Linear', 'None', '<p style="margin-bottom:0.75em">Recommended settings: Sampling Steps: 80-100, Sampler: Euler a, Denoising strength: 0.8</p>', 128, 8, ['left', 'right', 'up', 'down'], 1.0, 0.05, 128, 4, 'fill', ['left', 'right', 'up', 'down'], False, False, 'positive', 'comma', 0, False, False, '', '<p style="margin-bottom:0.75em">Will upscale the image by the selected scale factor; use width and height sliders to set tile size</p>', 64, 'None', 2.0, 'Seed', '', 'Nothing', '', 'Nothing', '', True, False, False, False, 0]
